...
- **Phase F** — documentation (the Sourcey site at [home](/), SimpleRPG-driven feature gallery, marketing README, full audit).
...
- **Feature gallery** — `docs/content/site/features/` fills with screenshot-driven pages (harbors, bridges, multi-depth, prop injection, cross-kit composition, determinism) produced by SimpleRPG.
